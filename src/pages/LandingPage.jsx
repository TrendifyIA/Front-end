...
const LandingPage = () => {
  return (
    ...
    <div className="min-h-screen bg-[#0c1f57] flex flex-col font-family">
        ...
        <div className="flex items-start gap-4 bg-[#fff] p-4 rounded-lg">
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4 bg-[#E1ECFD] p-4 rounded-lg">
              ...
              <p className="text-gray-700 text-lg">
                Analiza las principales tendencias que afectan tu mercado y toma
                decisiones.
              </p>
            </div>
            <div className="flex items-start gap-4 bg-[#E1ECFD] p-4 rounded-lg">
              ...
              <p className="text-gray-700 text-lg">
                Realiza nuevas estrategias a partir de datos confiables y
                comunícalas con tu equipo.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center bg-white mt-28">
            ...
            <p className="text-gray-600 text-lg bg-[#fff]">
              El mercado cambia en segundos. No dejes que tu empresa se quede
              atrás.
            </p>
          </div>
        </div>
      ...
      {/* Sección de encuestas inteligentes */}
      ...
      {/* Sección de datos para el crecimiento */}
      <div className="bg-[#E1ECFD] py-16 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center">
            <img
              src={Illustration2}
              alt="Datos que impulsan tu crecimiento"
              className="w-full max-w-md"
            />
          </div>
      ...
      {/* Sección de testimonio y cierre */}
      <div
