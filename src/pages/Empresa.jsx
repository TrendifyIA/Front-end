...
const Empresa = () => {
  return (
    <div class="flex flex-col gap-5 w-full p-10">
        ...
        <div class="bg-white shadow-md rounded-2xl p-6 w-[700px]">
            <div class="flex flex-row gap-4 w-full">
                ...
                <div class="flex flex-col gap-2 mb-4 w-1/2">
                    ...
                    <select name="Segmento de marcado" id="segment" class="text-gray-400| border-2 border-neutral-400 p-2 rounded-[5px] focus:outline-none focus:border-secondary-400">
        ...
        <h1 className='text-4xl font-bold'>Plan de comunicación</h1>
        <div class="bg-white shadow-md rounded-2xl p-6 w-[700px]">
            <div class="flex flex-row gap-4 w-full">
                <div class="flex flex-col gap-2 mb-4 w-1/2">
                    <label htmlFor="nameCompany" class="font-medium">Nombre de la empresa:</label>
