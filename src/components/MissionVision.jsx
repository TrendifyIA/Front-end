  ...
  const cards = [
    {
      ...
      icon: TargetIcon,
      content:
        "Brindar a empresas y agencias de marketing acceso inmediato a información precisa, relevante y predictiva sobre tendencias de mercado, facilitando decisiones estratégicas más rápidas, efectivas y con mayor retorno de inversión.",
    },
    {
      title: "Visión",
      icon: EyeIcon,
      content:
        "Ser la plataforma líder en inteligencia de tendencias en América Latina, transformando la manera en que las empresas comprenden y anticipan el mercado, mediante tecnología innovadora y análisis en tiempo real.",
    },
    {
      title: "Valores",
      icon: CheckIcon,
  ...
  return (
    <div className="grid md:grid-cols-3 gap-8 my-12">
      {cards.map((card, index) => (
        <div
          key={index}
          className="bg-blue-300 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all"
        >
